...
class DataService{
    ...
    // creates a chid of the base named 'users'
    private var _REF_USERS = DB_BASE.child("users")
    // creates a chid of the base named 'drivers'
    private var _REF_DRIVERS = DB_BASE.child("drivers")
    // creates a chid of the base named 'trips'
    ...
    func createFirebaseDBUser(uid: String, userData: Dictionary<String, Any>, isDriver: Bool){
        if isDriver{
            // identify the driver or users by their uid and add the userData
